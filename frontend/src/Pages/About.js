                    ...
                    <div className="row ptb--92 ptb_md--40 ptb_sm--40 position-relative">
                        <div className="col-lg-12">
                            <div className="rbt-breadcrumb-inner text-center">
                                <h2 className="rbt-breadcrumb-title h1"> <span>About US</span></h2>
                        ...
                        <div className="rbt-breadcrumb-bg-elements">
                            <div className="rbt-breadcrumb-bg-element-1 rbt-scroll-trigger fade_in animation-order-2">
                                <img src="assets/images/breadcrumb-bg/bg-element-01.webp" alt="Breadcrumb BG" />
                            </div>
                            <div className="rbt-breadcrumb-bg-element-2 rbt-scroll-trigger fade_in animation-order-3">
                                <img src="assets/images/breadcrumb-bg/bg-element-02.webp" alt="Breadcrumb BG" />
                            </div>
                            <div className="rbt-breadcrumb-bg-element-3 rbt-scroll-trigger fade_in animation-order-4">
                                <img src="assets/images/breadcrumb-bg/bg-element-03.webp" alt="Breadcrumb BG" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="rbt-component-section-title rbt-about-banner-fshape-title rbt-bg-color-white">
                                            <h3 className="rbt-title rbt-text-color-primary h4"><span className="rbt-bold--text">About
                                                Us</span></h3>
                                                            ...
                                                            <div className="swiper-wrapper">
                                                                ...
                                                                <div className="swiper-slide">
                                                                    <div className="rbt-about-banner-img">
                                                                        <img src="assets/images/about/about-image-1.webp" alt="About us image" />
                                                                    </div>
                                                                </div>
                                                                <div className="swiper-slide">
                                                                    <div className="rbt-about-banner-img">
                                                                        <img src="assets/images/about/about-mobile-a-02.webp" alt="About us image" />
                                                                    </div>
                                                                </div>
                                                                <div className="swiper-slide">
                                                                    <div className="rbt-about-banner-img">
                                                                        <img src="assets/images/about/about-mobile-a-03.webp" alt="About us image" />
                                                                    </div>
                                                                </div>
                                                                <div className="swiper-slide">
                                                                    <div className="rbt-about-banner-img">
                                                                        <img src="assets/images/about/about-mobile-a-01.webp" alt="About us image" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {/* pagination */}
                                ...
                                <div className="inner">
                                    <div className="rbt-section-title text-start">
                                        ...
                                        <p className="rbt-description">
                                            Let the beauty of what you love be what you do. Lorem Ipsum is
                                    ...
                                    <div className="rbt-about-feature-wrapper mt--32">
                                        <div className="rbt-about-feature feature-style-1">
                                            ...
                                            <div className="rbt-feature-content">
                                                <h4 className="rbt-feature-title h6">Innovation in Shopping</h4>
                                                <p className="rbt-feature-description">Our platform is designed with the latest
                                                    technology to make online shopping enjoyable.</p>
                                            </div>
                                        </div>
                                        <div className="rbt-about-feature feature-style-1">
                                            <span className="icon">
                                            ...
                                            <div className="rbt-feature-content">
                                                <h4 className="rbt-feature-title h6">Secure &amp; Fast Delivery</h4>
                                                <p className="rbt-feature-description">Enjoy quick and reliable shipping with
                                                    complete security and tracking at every step.</p>
                                            </div>
                                        </div>
                                        <div className="rbt-about-feature feature-style-1">
                                            <span className="icon">
                                            ...
                                            <div className="rbt-feature-content">
                                                <h4 className="rbt-feature-title h6">Your Shopping, Your Way</h4>
                                                <p className="rbt-feature-description">Explore a wide range of products tailored to
